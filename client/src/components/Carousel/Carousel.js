            ...
            <Carousel fade={true} className="carousel" controls={true}>
                <Carousel.Item interval={4000}>
                    ...
                    <Carousel.Caption className='carSlideText carousel-caption'>
                        ...
                        <p className='slideText'>Measure around your neck over your Adam's apple, following its natural curve.</p>
                    </Carousel.Caption>
                </Carousel.Item>
                <Carousel.Item interval={4000}>
                    <img
                    ...
                    <Carousel.Caption className='carSlideText carousel-caption'>
                        ...
                        <p className='slideText'>Identify the bones at the top edge of each shoulder. Measure from bone to bone, over the natural curve of your back.</p>
                    </Carousel.Caption>
                </Carousel.Item>
                <Carousel.Item interval={4000}>
                    <img
                    ...
                    <Carousel.Caption className='carSlideText carousel-caption'>
                        ...
                        <p className='slideText'>Relax your arms at your sides. Wrap the tape measure around your bicep in line with your nipples.</p>
                    </Carousel.Caption>
                </Carousel.Item>
                <Carousel.Item interval={4000}>
                    <img
                    ...
                    <Carousel.Caption className='carSlideTextLg carousel-caption'>
                        ...
                        <p className='slideText'>Relax your arms. Measure the length in two steps. Start from the bone at the top edge of your shoulder and measure to your elbow. Hold the tape measure there and continue measuring to your wrist, just below your wrist bone.</p>
                    </Carousel.Caption>
                </Carousel.Item>
                <Carousel.Item interval={8000}>
                    ...
                    <Carousel.Caption className='carSlideText carousel-caption'>
                        ...
                        <p className='slideText'>Wrap the tape measure around your wrist, just below your wrist bone.</p>
                ...
                <Carousel.Item interval={4000}>
                    ...
                    />
                    <Carousel.Caption className='carSlideText carousel-caption'>
                        <h3 className='slideTitle'>Stomach</h3>
                        <p className='slideText'>Wrap the tape measure around your stomach in line with your belly button. Ensure the tape measure is level all the way around.</p>
                    </Carousel.Caption>
                </Carousel.Item>
                <Carousel.Item interval={4000}>
                    <img
                ...
                <Carousel.Item interval={8000}>
                    ...
                    <Carousel.Caption className='carSlideText carousel-caption'>
                        ...
                        <p className='slideText'>Wrap the tape measure around your hips at the widest point of your bum. Ensure the tape measure is level all the way around.</p>
                    </Carousel.Caption>
                </Carousel.Item>
                <Carousel.Item interval={4000}>
                    <img
                    ...
                    <Carousel.Caption className='carSlideTextLg carousel-caption'>
                        ...
                        <p className='slideText'>Locate your waist by placing four fingers beneath your belly button and wrapping the tape measure level around your waistline just below your fourth finger. Mark a point at one side and remove the tape measure. Measure your leg from that point straight down to the floor.</p>
                    </Carousel.Caption>
                </Carousel.Item>
                <Carousel.Item interval={8000}>
                    <img
                ...
                <Carousel.Item interval={11000}>
                    ...
                    <Carousel.Caption className='carSlideText carousel-caption'>
                        ...
                        <p className='slideText'>Wrap the tape measure around your thigh just below the crotch. Ensure the tape measure is level all the way around.</p>
                    </Carousel.Caption>
                </Carousel.Item>
                <Carousel.Item interval={4000}>
                    <img
                    ...
                    <Carousel.Caption className='carSlideText carousel-caption'>
                        ...
                        <p className='slideText'>Wrap the tape measure around your knee cap at the widest point. Ensure the tape measure is level all the way around.</p>
                    </Carousel.Caption>
                </Carousel.Item>
